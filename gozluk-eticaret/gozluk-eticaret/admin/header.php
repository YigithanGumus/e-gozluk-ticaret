    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center mt-3" href="index.php">
                <div class="sidebar-brand-text mx-3"><img src="../dosyalar/<?php echo $ayarcek['site_logo']  ?>" class="img-fluid"></div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="iletisim.php">İletişim/Bize Ulaş</a>
                        <a class="collapse-item" href="carousel.php">Carousel</a>
                        <a class="collapse-item" href="kullanicilar.php">Kullanıcılar</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Ürün Ayarları</h6>
                        <a class="collapse-item" href="urun.php">Ürünler</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle" src="kisiler/<?php echo $_SESSION['kul_resim'] ?>">
                ...
                <?php  
                    if (@$_GET['durum']=="profilguncellendi") { ?>
                        // code...
                    <?php } ?>
